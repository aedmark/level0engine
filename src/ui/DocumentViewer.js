...
export default class DocumentViewer {
    ...
    bindEvents() {
        ...
        document.addEventListener('somatic-close-document', () => {
            ...
            // If Inquest is open, DocumentViewer yields to InquestController.
            // But we must check if inquest exists and is block
            if (inquestOverlay && inquestOverlay.style.display === 'block') {
                return; // Handled by InquestController
            }
            ...
            if (keypadOverlay && keypadOverlay.style.display === 'block') {
                // Handled by KeypadController, but close-document triggers it

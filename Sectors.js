...
//
// One row per macro zone: atmosphere (fog density + tint), ambience DSP,
// footstep foley, and spatial reverb. Adding a zone means adding a row here
// plus its blueprint in TheArchitect's sector matrix.
//
// Missing fields fall back at the consumer: fogColor -> base haze,
// ambience -> NORMAL, foley -> DEFAULT_FOLEY, delay/feedback -> 0.15/0.2.
...
const SECTORS = {
    ...
    IMPOUND: {
        fog: 0.08, fogColor: 0x7a6238,
        ambience: {noise: 0.09, peace: 0.0, rumble: 45, freq: 160, freqOcc: 90, whine: 0.0008, whineOcc: 0.0003, dynamicWhine: false},
        foley: {oscFreq: 120, filterType: 'lowpass', filterFreq: 900, gain: 0.11, attack: 0.02, decay: 0.12},
        delay: 0.45, feedback: 0.35
    },
    BOARDROOM: {
        fog: 0.05, fogColor: 0x878a8d,
    ...
    INCINERATOR: {
        fog: 0.20, fogColor: 0x551100,
        ambience: {noise: 0.65, peace: 0.0, rumble: 180, freq: 60, freqOcc: 60, whine: 0.0, whineOcc: 0.0, dynamicWhine: false},
